...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="../assets/images/iconv.png" alt="AdminLTELogo" height="100" width="100">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="../assets/images/iconv.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">UPMtalk</span>
    </a>
              ...
              <form method="post" action="php/admin_actions.php?updateprofile">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="password" value="password" class="form-control" id="exampleInputPassword1" placeholder="Password">
...
?>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2022 <a href="#" target="_blank">UPM talk</a>.</strong>
    All rights reserved.
